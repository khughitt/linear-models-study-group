...
Let $V$ be an $n \times p$ non-negative matrix. NMF attempts to find non-negative 
matrices $W$ ($n \times r$) and $H$ ($r \times p$), whose product approximates $V$:
...
for R (`r citep('10.1186/1471-2105-11-367')`)...
